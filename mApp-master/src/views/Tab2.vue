...
export default {
  ...
  methods: {
        ...
        buttons: [
          {
            ...
            handler: async () => {
              ...
              await axios.delete("http://localhost:3001/mongo/products/" + id)
              this.allProduct();
            },
          },
          {
    ...
    async allProduct() {
      try {
        const res = await axios.get("http://localhost:3001/mongo/products");
        ...
        buttons: [
          {
            ...
            handler: async (data) => {
              if (data.product_id && data.product_name && data.product_price) {
                ...
                await axios
                  .post("http://localhost:3001/mongo/products", data)
                  .then(function (res) {
